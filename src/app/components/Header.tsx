  ...
  return (
    <header className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between border-b border-navy-700 pb-5 mb-6">
      <div className="flex items-center gap-3">
        <div
          aria-hidden
          className="h-10 w-10 rounded-xl bg-gradient-to-br from-accent-electric to-accent-neon shadow-glow grid place-items-center text-navy-950 font-black text-lg"
        >
          GR
        </div>
        <div>
      ...
      <button
        ...
        className={[
          ...
          "hover:bg-accent-neon hover:text-navy-950",
